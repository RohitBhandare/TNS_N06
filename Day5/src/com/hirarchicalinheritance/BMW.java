...
public class BMW extends Car {
	...
	public BMW(int noOfWheels, String engine, int noOfDoors, String name, String color, int milege, float speed) {
	...
	public String toString() {
		return "BMW [Car name=" + name + ", color=" + color + ", milege=" + milege + ", speed=" + speed + ", getName()="
